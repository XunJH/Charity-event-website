...
CREATE TABLE `event_registrations` (
  ...
  CONSTRAINT `event_registrations_ibfk_1` FOREIGN KEY (`event_id`) REFERENCES `charity_events` (`event_id`)
...
(1,1,'John Doe','john@example.com',2,400.00,'2025-10-05 08:30:00','confirmed'),
(2,2,'Jane Smith','jane@example.com',1,35.00,'2025-10-05 09:15:00','confirmed'),
(3,5,'Mike Wilson','mike@example.com',3,120.00,'2025-10-05 10:00:00','confirmed');
